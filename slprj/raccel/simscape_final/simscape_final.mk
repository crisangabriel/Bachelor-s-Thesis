...
MODEL                   = simscape_final
MODULES                 = rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_zcfcn.c simscape_final.c simscape_final_capi.c simscape_final_data.c simscape_final_tgtconn.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = simscape_final
MAKEFILE                = simscape_final.mk
MATLAB_ROOT             = /Applications/MATLAB_R2023a.app
ALT_MATLAB_ROOT         = /Applications/MATLAB_R2023a.app
START_DIR               = /Users/gabrielcrisan/Desktop/LICENTA/Matlab_work/MPPT/final
S_FUNCTIONS_LIB         = 
NUMST                   = 4
NCSTATES                = 2
COMPUTER                = MACI64
BUILDARGS               =  RSIM_SOLVER_SELECTION=1 PCMATLABROOT="/Applications/MATLAB_R2023a.app" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 RSIM_PARAMETER_LOADING=1 OPTS="-DTGTCONN -DIS_SIM_TARGET -DNRT -DRSIM_PARAMETER_LOADING -DRSIM_WITH_SL_SOLVER -DENABLE_SLEXEC_SSBRIDGE=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=0" MACOSX_VERSION_MIN_FLAG="-mmacosx-version-min=10.15"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 1
ALLOCATIONFCN           = 0
...
ADDITIONAL_LDFLAGS      =  -Wl,-rpath,/Applications/MATLAB_R2023a.app/bin/maci64 -Wl,-rpath,/Applications/MATLAB_R2023a.app/sys/os/maci64 -Wl,-rpath,@executable_path -Wl,-rpath,@executable_path/../../.. -L/Applications/MATLAB_R2023a.app/sys/os/maci64
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/simscape_final \
